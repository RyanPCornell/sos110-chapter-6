...
- `ipat-simulator/` — the **I = PAT Simulator** app embedded on slide 22
...
- **Slide 15 — DTM Explorer.** Sliders set the birth and death rate for each of
...
- **Slide 22 — I = PAT Simulator.** Dial Population × Affluence × Technology and
  watch environmental impact respond.
- **Slide 23 — What Can I Do?** Four hand-drawn pledges that tick when tapped.
...
**Due dates** on the Announcements slide (slide 3) live in the `ASSIGNMENTS` list
